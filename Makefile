...
.PHONY: all help tb-build tb-run sim rv32i-build rv32i-run rv32i-asm synth schematic clean distclean
...
clean:
	rm -f $(SIM) $(RV32I_SIM) waveform.vcd abc.history tb.out $(SCHEMATIC) tests/RV32I/basic.o tests/RV32I/basic.elf tests/RV32I/basic.bin
